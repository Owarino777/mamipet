...
export function PetSitterOnboardingPage() {
  ...
  const canPublishProfile =
    ...
    assessmentCards.every((card) => completedAssessmentSet.has(card.animalOptionId));
  ...
  function handleValidateAssessmentQuestion() {
    ...
    if (!isCorrect) {
      setAssessmentFeedback("Ce n'est pas encore la bonne combinaison. Réessaie.");
      return;
    }
    ...
    const nextCompletedSet = new Set(nextCompletedAssessmentIds);
            ...
            >
              ...
              {canPublishProfile ? (
                <div className="pet-sitter-test-question-card">
                  <p className="pet-sitter-test-question-index">Tests terminés</p>
                  <h1>Ton profil pet-sitter est prêt.</h1>
                  <p>Clique pour publier ton profil et rejoindre ton espace.</p>
                </div>
              ) : (
                <div className="pet-sitter-test-question-card">
              ...
              <button
                ...
                onClick={
                  canPublishProfile
                    ...
                    : handleValidateAssessmentQuestion
                }
                type="button"
              >
